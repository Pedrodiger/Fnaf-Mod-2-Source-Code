...
public class BlueAndRedTilesBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod_:blue_and_red_tiles")
	public static final Block block = null;
	public BlueAndRedTilesBlock(FnafModModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(10f, 10f).setLightLevel(s -> 0)
					.slipperiness(1f));
			setRegistryName("blue_and_red_tiles");
		}
